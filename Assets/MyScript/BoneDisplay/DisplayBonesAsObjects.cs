...
public class DisplayBonesAsObjects : MonoBehaviour
{
        ...
        foreach (HumanBodyBones bone in System.Enum.GetValues(typeof(HumanBodyBones)))
        {
            ...
            if (boneTransform != null)
            {
                ...
                if (boneTransform.parent != null)
                {
                    ...
                    // 更新用スクリプトを追加して線を追従
                    BoneLineUpdater updater = lineObject.AddComponent<BoneLineUpdater>();
...
public class BoneLineUpdater : MonoBehaviour
{
    public DisplayBonesAsObjects displayBonesAsObject;
